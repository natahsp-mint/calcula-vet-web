...
if drug == "amoxicilina":
    dosage = float(input("Qual a dosagem desejada entre 10-20mg/kg? Digite apenas o número: "))
    dose = dosage * weight
...
if drug == "metronidazol":
    ...
    print("2 - Anaeróbicos")
    while True:
        case = input("Selecione o caso (digite apenas o número): ")
        if case == "1":
            dose = 25 * weight
...
if drug == "omeprazol":
    dosage = float(input("Qual dosagem desejada entre 0.5-1mg/kg? Digite apenas o número: "))
    dose = dosage * weight
...
if drug == "prednisolona":
    ...
    while True:
        if species == "1" and case == "1":
            ...
            dosage = float(input("Qual a dosagem desejada entre 0.5-2mg/kg? Digite apenas o número: "))
            dose = dosage * weight
            ...
            dosage = float(input("Qual a dosagem desejada entre 2-4mg/kg? Digite apenas o número: "))
            dose = dosage * weight
